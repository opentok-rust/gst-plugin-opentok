...
fn create_pipeline(settings: cli::Settings) -> Result<gst::Pipeline> {
    ...
    let audiotestsrc = gst::ElementFactory::make("audiotestsrc", None)
    ...
    let timeoverlay = gst::ElementFactory::make("timeoverlay", None)
    ...
    let video_capsfilter = gst::ElementFactory::make("capsfilter", None).unwrap();
